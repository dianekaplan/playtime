...
public class fasta_utils {
    ...
    protected static List<String> get_seq_strings(String string_name)
    {

        List<String> temp_list = readFile(string_name);

        // Later, add function to clean the list (change to uppercase, replace spaces, newlines, etc
